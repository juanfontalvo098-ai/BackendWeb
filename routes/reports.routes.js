...
router.post('/reorder-shifts', rbac('admin', 'super_admin', 'gerente'), reportsController.reorderShifts);
router.get('/export/consolidated', rbac('admin', 'cajero', 'gerente'), reportsController.exportConsolidatedExcel);
